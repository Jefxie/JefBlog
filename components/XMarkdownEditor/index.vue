<template lang="html">
  ...
  >
    ...
    <ul class="markdown-toolbars">
      ...
      <li v-if="tools.image" class="upload-img" name="图片">
        <!-- <input @click="insertImage" class="iconfont icon-img"></span> -->
        <label class="iconfont icon-img" for="file-img"></label>
		    <input @change="getFile" id="file-img" class="input" type="file">
      </li>
